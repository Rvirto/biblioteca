...
/**
 * Loan Endpoint Test class for validations of all existing endpoints and their returns from the Loan endpoint class
 *
...
public class LoanEndpointTest extends ApplicationTests<LoanEndpointTest> {
    ...
    public void shouldReturnOkWhenGetLoanById() throws Exception {
        ...
        final String uri = fromPath(LoanEndpoint.LOAN_SELF_PATH).buildAndExpand("a5993416-4255-11ec-71d3-0242ac130004").toUriString();
    ...
    public void shouldReturnNotFoundWhenGetLoanByIdThatDoesntExist() throws Exception {
        ...
        final String uri = fromPath(LoanEndpoint.LOAN_SELF_PATH).buildAndExpand("LOAN_ID_NOT_EXISTS").toUriString();
    ...
    public void shouldReturnCreatedWhenPostLoan() throws Exception {
        final String uri = fromPath(LoanEndpoint.LOAN_RESOURCE_PATH).toUriString();
    ...
    public void shouldReturnAcceptedWhenPostDevolution() throws Exception {
        ...
        final String uriDevolution = fromPath(LoanEndpoint.LOAN_DEVOLUTION_RESOURCE_PATH).buildAndExpand(loanId).toUriString();
    ...
    public void shouldReturnBadRequestWhenPostDevolutionWhenLoanIdNotExists() throws Exception {
        final String uri = fromPath(LoanEndpoint.LOAN_DEVOLUTION_RESOURCE_PATH).buildAndExpand("INVALID_LOAN_ID").toUriString();
    ...
    public void shouldReturnOkWhenGetLoanByClientId() throws Exception {
        final String uri = fromPath(LoanEndpoint.LOAN_RESOURCE_PATH)
        ...
        mockMvc.perform(get(uri))
                ...
                .andExpect(jsonPath("$._embedded.loans[0]._links['self'].href").value(containsString(LoanEndpoint.LOAN_RESOURCE_PATH.concat("/a5993416-4255-11ec-71d3-0242ac130004"))))
    ...
    public void shouldReturnOkWhenGetLoanByStatus() throws Exception {
        ...
        mockMvc.perform(get(uri))
                ...
                .andExpect(jsonPath("$._embedded.loans[0].client.documentType").value("CPF"))
                .andExpect(jsonPath("$._embedded.loans[0].client.documentValue").value("12345678998"))
                .andExpect(jsonPath("$._embedded.loans[0]._links['self'].href").value(containsString(LoanEndpoint.LOAN_RESOURCE_PATH.concat("/a5993416-4255-11ec-71d3-0242ac130006"))))
                .andExpect(jsonPath("$.page.size").value(10))
                .andExpect(jsonPath("$.page.totalElements").value(1))
                .andExpect(jsonPath("$.page.totalPages").value(1))
                .andExpect(jsonPath("$.page.number").value(0));
    ...
    public void shouldReturnBadRequestWhenGetLoanByInvalidMatrixVariable() throws Exception {
        final String uri = fromPath(LoanEndpoint.LOAN_RESOURCE_PATH).toUriString().concat(";invalid=invalid");
